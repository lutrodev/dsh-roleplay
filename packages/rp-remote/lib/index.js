...
let RoleplayRemoteHost = (() => {
	...
	return class RoleplayRemoteHost extends _classSuper {
		static {
			...
			__esDecorate(this, null, _assets_decorators, {
				kind: "method",
				name: "assets",
				static: false,
				private: false,
			...
			__esDecorate(this, null, _characterCards_decorators, {
				kind: "method",
				name: "characterCards",
				static: false,
				private: false,
				access: {
					has: (obj) => "characterCards" in obj,
					get: (obj) => obj.characterCards
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _features_decorators, {
				kind: "method",
				name: "features",
				static: false,
				private: false,
				access: {
					has: (obj) => "features" in obj,
					get: (obj) => obj.features
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _loreBooks_decorators, {
				kind: "method",
				name: "loreBooks",
				static: false,
				private: false,
				access: {
					has: (obj) => "loreBooks" in obj,
					get: (obj) => obj.loreBooks
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _messageActions_decorators, {
				kind: "method",
				name: "messageActions",
				static: false,
				private: false,
				access: {
					has: (obj) => "messageActions" in obj,
					get: (obj) => obj.messageActions
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _personas_decorators, {
				kind: "method",
				name: "personas",
				static: false,
				private: false,
				access: {
					has: (obj) => "personas" in obj,
					get: (obj) => obj.personas
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _presets_decorators, {
				kind: "method",
				name: "presets",
				static: false,
				private: false,
				access: {
					has: (obj) => "presets" in obj,
					get: (obj) => obj.presets
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _quickReplies_decorators, {
				kind: "method",
				name: "quickReplies",
				static: false,
				private: false,
				access: {
					has: (obj) => "quickReplies" in obj,
					get: (obj) => obj.quickReplies
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _subagents_decorators, {
				kind: "method",
				name: "subagents",
				static: false,
				private: false,
				access: {
					has: (obj) => "subagents" in obj,
					get: (obj) => obj.subagents
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _writingStyles_decorators, {
				kind: "method",
				name: "writingStyles",
				static: false,
				private: false,
				access: {
					has: (obj) => "writingStyles" in obj,
					get: (obj) => obj.writingStyles
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		handlers = (__runInitializers(this, _instanceExtraInitializers), /* @__PURE__ */ new Map());
		constructor(ctx) {
		...
		async dispatch(route, endpoint, payload, signal) {
			...
			if (handler === void 0) throw new Error(`rp-remote: no handler is registered for ${route}`);
			return await handler(endpoint, payload, signal);
		}
	};
})();
//#endregion
export { ROLEPLAY_REMOTE_ROUTES, RoleplayRemoteHost, RoleplayRemoteHost as default };
